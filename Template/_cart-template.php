                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex pt-2">
                            ...
                            <form method="post">
                                ...
                                <button type="submit" name="delete-cart-submit" class="btn font-baloo text-danger px-3 border-right">Удалить</button>
                            </form>

                            <form method="post">
                                <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                <button type="submit" name="wishlist-submit" class="btn font-baloo text-danger">Отложить</button>
                            </form>
